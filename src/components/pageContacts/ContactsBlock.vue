  ...
  <div :class="contactsClasses">
    <ul class="contacts-list">
      ...
      >
        ...
        <v-icon class="contacts-icon" :icon="item.icon" />

        <div class="contacts-info">
          <p class="contacts-title">{{ item.title }}</p>

          <p class="contacts-description" v-html="item.subtitle" />
        </div>
      </li>
    </ul>
...
export default {
  ...
  data() {
    return {
      contacts: this.$tm('contacts.items'),
      isOpenModal: false
    };
  },
